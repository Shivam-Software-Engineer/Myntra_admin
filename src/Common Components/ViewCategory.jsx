...
export default function ViewCategory() {
    ...
    const updateCategoryStatus = async (
        ...
        try {
            ...
            setStatusLoading(categoryId);


            await axios.put(
                `${BaseUrl}/category/update-status/${categoryId}`,
                {
                    status
                }
            );
    ...
    const deleteCategory = async () => {
        ...
        const confirmDelete =
            window.confirm(
                `Are you sure you want to delete ${deleteIds.length} selected categor${deleteIds.length > 1
                    ? "ies"
                    : "y"
                }?`
            );
                                ...
                                {filteredCategories.map(
                                    (category, index) => (
                                        ...
                                        <tr
                                            ...
                                            className={`hover:bg-slate-50 transition ${index !==
                                                    ...
                                                    {statusLoading ===
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <select
                                                                ...
                                                                className={`rounded-lg border px-3 py-2 text-xs font-medium outline-none cursor-pointer ${category.active
